<form method="post" enctype="multipart/form-data" id="edit_user_form">
            ...
            <div class="modal-header">
              <h5 class="modal-title h4" id="myLargeModalLabel">My Profile</h5>
					...
					<div class="row">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                               ...
                               <input class="form-control" type="text" placeholder="Country" value="<?php echo $result[0]->country;?>" name="country" id="country">
